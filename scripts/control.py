...
if __name__=='__main__':
    ...
    while not rospy.is_shutdown():
        kp = rospy.get_param("/control/kp", default = 0.1)
        ki = rospy.get_param("/control/ki", default = 0.0)
        kd = rospy.get_param("/control/kd", default = 0.0)
        dt = rospy.get_param("/control/dt", default = 0.01)
